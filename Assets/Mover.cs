...
public class Mover : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //The new Vector3 consists of x, y, and z coordinates. 
        //transform.position.y and transform.position.z never change, but the x position does.
        //Mathf is a library of math function for Unity, and .PingPong is a method that returns a value based on two input variables.
